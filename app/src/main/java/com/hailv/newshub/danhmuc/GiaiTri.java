...
public class GiaiTri extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new DownloadTask().execute("https://guu.vn/cat/guu-an-choi");
    }
    ...
    private class DownloadTask extends AsyncTask<String, Void, ArrayList<News>> {
        ...
        protected void onPostExecute(ArrayList<News> news) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(GiaiTri.this,R.layout.item_main,news);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.giai_tri, menu);
        return true;
    }
