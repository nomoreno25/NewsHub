...
public class NguoiNoiTieng extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nguoi_noi_tieng);
        ...
        new DownloadTask().execute("https://guu.vn/cat/guu-ngoi-sao");
    }
    ...
    private class DownloadTask extends AsyncTask<String, Void, ArrayList<News>> {
        ...
        protected void onPostExecute(ArrayList<News> news) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(NguoiNoiTieng.this,R.layout.item_main,news);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.nguoi_noi_tieng, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            startActivity(new Intent(NguoiNoiTieng.this, MainActivity.class));
            finish();
        } else if (id == R.id.nav_categories) {
            startActivity(new Intent(NguoiNoiTieng.this, CategoriesActivity.class));
            finish();
        } else if (id == R.id.nav_favorites) {
            startActivity(new Intent(NguoiNoiTieng.this, FavActivity.class));
            finish();
