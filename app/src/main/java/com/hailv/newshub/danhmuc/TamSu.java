...
public class TamSu extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tam_su);
        ...
        new DownloadTask().execute("https://guu.vn/cat/guu-tam-su");
    }
    ...
    private class DownloadTask extends AsyncTask<String, Void, ArrayList<News>> {
        ...
        protected void onPostExecute(ArrayList<News> news) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(TamSu.this,R.layout.item_main,news);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.tam_su, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            startActivity(new Intent(TamSu.this, MainActivity.class));
            finish();
        } else if (id == R.id.nav_categories) {
            startActivity(new Intent(TamSu.this, CategoriesActivity.class));
            finish();
        } else if (id == R.id.nav_favorites) {
            startActivity(new Intent(TamSu.this, FavActivity.class));
            finish();
